...
| `openwrt_dns_validation_domain`           | `string`     | `"google.com"`       | `"github.com"`                                                                                               | FQDN used during name resolution test                                                                                        |
| `openwrt_dns_validation_server`           | `string`     | `"1.1.1.1"`          | `"8.8.8.8"`                                                                                                  | DNS server added to `resolv.conf` after failed name resolution test.                                                         |
